...
@Component({
  selector: "app-create-chemical-fertilizer-sources",
  templateUrl: "./create-chemical-fertilizer-sources.component.html",
  styleUrls: ["./create-chemical-fertilizer-sources.component.scss"],
})
export class CreateChemicalFertilizerSourcesComponent implements OnInit {
  form = new FormGroup(
    {
  ...
  getUser = (id: any) => {
    ...
    this._CrudRequestsService
      .get("chemical_fertilizer_sources/" + id)
      .subscribe((data: any) => {
  ...
  sendData = () => {
    ...
    if (this.form.valid) {
      ...
      if (this.isEdit) {
        this._crud
          .put(`chemical_fertilizer_sources/${this.idEdit}`, data)
          .subscribe(
            (res: any) => {
              this.loading = false;
              this.isSubmit = false;
        ...
        this._crud.post(`chemical_fertilizer_sources`, data).subscribe(
          (res: any) => {
            this.loading = false;
            this.isSubmit = false;
  ...
  goBack = () => {
    this.route.navigate(["/admin/farmer/chemical-fertilizer-sources"]);
  };
}
