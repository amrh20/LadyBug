...
@Component({
  selector: "app-create-plant-sources",
  templateUrl: "./create-plant-sources.component.html",
  styleUrls: ["./create-plant-sources.component.scss"],
})
export class CreatePlantSourcesComponent implements OnInit {
  form = new FormGroup(
    {
  ...
  getUser = (id: any) => {
    ...
    this._CrudRequestsService
      .get("home_plant_illuminating_sources/" + id)
      .subscribe((data: any) => {
  ...
  sendData = () => {
    ...
    if (this.form.valid) {
      ...
      if (this.isEdit) {
        this._crud
          .put(`home_plant_illuminating_sources/${this.idEdit}`, data)
          .subscribe(
            (res: any) => {
              this.loading = false;
              this.isSubmit = false;
        ...
        this._crud.post(`home_plant_illuminating_sources`, data).subscribe(
          (res: any) => {
            this.loading = false;
            this.isSubmit = false;
  ...
  goBack = () => {
    this.route.navigate(["/admin/farmer/plant-illuminating-sources"]);
  };
}
